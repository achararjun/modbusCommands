...
void loop() {
  uint8_t readPeakCurrent[] = {0x01, 0x03, 0x01, 0x91, 0x00, 0x01}; // Modbus message without CRC
  uint8_t motorEnable[] = {0x01, 0x06, 0x18, 0x01, 0x11, 0x22}; // Another Modbus message without CRC
  uint8_t setSpeed60[] = {0x01, 0x06, 0x01, 0xE1, 0x00, 0x3C};
  uint8_t setPulse200[] = {0x01, 0x06, 0x01, 0x03, 0x00,0x38};
